...
export function FormPanel({
  ...
  return (
    <aside className="form-panel">
      ...
      <div className="form-panel__scroll" role="region" aria-label="Org Chart Form">
        ...
        <div className="form-panel-section">
          <div className="form-panel-section__title">Default chart</div>
          <p className="form-panel-section__note">The chart is stored in your browser. If you still see an old CTO tree after an update, click below to load the version from the app code.</p>
          <div className="form-actions">
            <button type="button" className="btn btn-secondary" onClick={onResetToDefault}>Reset to default chart</button>
          </div>
        </div>
